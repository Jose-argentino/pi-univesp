...
class HabilidadesCandidato(Base):
    ...
    candidato_rel = relationship('Candidato', backref='cand_habilidade', foreign_keys=[id_candidato])
    habilidade_rel = relationship('Habilidade', backref='hab_habilidade', foreign_keys=[id_hab])
