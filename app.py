...
with app.app_context(): #equivalente a @app.route('/') no projeto do teste_db
    ...
    for i in result1: #0 se refere a candidato, 1 a contratação e 2 a infoormações extras
        print(i[0].p_nome, i[0].cidade, i[0].telefone, i[0].exp_anos, i[1].tipo_contrato, i[2].certificacao)
